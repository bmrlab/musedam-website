...
export const useFAQTranslation = () => useTranslation('faq')
export const useInformationTranslation = () => useTranslation('information')
export const useBlogTranslation = () => useTranslation('blog')
export const useHelpCenterTranslation = () => useTranslation('help-center')
