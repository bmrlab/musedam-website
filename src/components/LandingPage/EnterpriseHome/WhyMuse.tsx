...
export default function WhyMuse() {
    ...
    const data: AINativeCard[] = [
        {
            key: 'collect',
            title: 'No.1',
            description: 'DAM + GenAI solution',
            icon: <StarFilledIcon />,
        },
        {
            key: 'organize',
        ...
        },
        {
            key: 'ai-generate',
            title: '150m+',
            description: 'Content assets in managed',
            icon: <ImageIcon />,
        },
        {
            key: 'Compliance',
            title: '800k+',
            description: 'Content generate daily',
            icon: <TableIcon />,
        },
        {
            key: 'Data-Driven',
            title: '100k+',
            description: 'Daily content distribution',
            icon: <BarChartIcon />,
        }
    ]
    ...
    return <div className='p-5 md:px-[80px] md:py-[60px] md:pb-[120px]'>
        <div className='flex w-full flex-col items-center overflow-x-scroll md:max-w-[1440px]'>
            <h1 className="max-w-[791px] text-start text-[32px] font-normal leading-[41.6px] text-[rgba(255,255,255,0.72)]  md:text-[64px] md:leading-[73.6px]">
                MuseDAM, an AI-native digital asset management platform, revolutionizes enterprise digital asset management for leading global brands.
            </h1>
            ...
            <div className='mt-[80px] flex w-full flex-col items-center justify-between gap-2 rounded-[34px] bg-[#FF2EE7] p-5 md:flex-row md:rounded-[56px] md:px-[60px] md:py-[50px]'>
                <div className='flex-1 text-3xl md:max-w-[910px] md:text-[54px] md:leading-[60px]'>
                    <span className='text-black'>Experience MuseDAM's AI-Native Platform. <span className='text-white'>Free demo, instant insights.</span></span>
                </div>
