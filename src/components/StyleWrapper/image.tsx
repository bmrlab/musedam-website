...
export const BottomToTopImage = twx(AnimationImagePreset)`slide-in-from-bottom`
export const TopToBottomImage = twx(AnimationImagePreset)`slide-in-from-top`
export const LeftToRightImage = twx(AnimationImagePreset)`slide-in-from-left`
export const RightToLeftImage = twx(AnimationImagePreset)`slide-in-from-right`
