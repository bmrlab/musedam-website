      ...
      <FlexColContainer className="mt-[30px] w-full items-center px-5 font-euclid md:px-[74px]">
        <FlexRowContainer className="mb-6 w-full justify-between">
          ...
          <div
            ...
            onClick={() => {
              window.open(`/settings/checkout/points?source=MuseDAM`)
            }}
          >
          ...
          {billingMenu[currentPlan].map((plan) => {
            ...
            return (
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {
                    if (buttonType === 'contact') {
                      ...
                      window.open(`/settings/checkout/plan?product=${priceKey}`, '_blank')
                ...
                {linkText && (
                  <a
                    href={`/settings/checkout/plan?product=${priceKey}`}
                    target="_blank"
