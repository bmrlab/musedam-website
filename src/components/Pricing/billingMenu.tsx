...
export const useBillingMenu = ({ isMuseAI }: { isMuseAI: boolean }) => {
    ...
    const museAIBillingMenu = {
        [PlanType.personal]: [
            ...
            },
            {
                ...
                desFn: (price: number) => t("pricing.menuCard.personal.price.des", { val: Math.ceil(price / 3) }),
            ...
            },
            {
                ...
                desFn: (price: number) => t("pricing.menuCard.personal.price.des", { val: Math.ceil(price / 12) }),
        ...
        [PlanType.team]: [
            ...
            },
            {
                ...
                desFn: (price: number) => t("pricing.menuCard.team.price.des", { val: price.toLocaleString() }),
    ...
    const billingMenu = useMemo(() => isMuseAI ? museAIBillingMenu : (isInChina ? domesticBillingMenu : abroadBillingMenu), [isMuseAI, isInChina, t])
