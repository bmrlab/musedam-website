...
export const MUSE_MAINLAND_SERVER_URL =
  process.env.NODE_ENV === 'development'
    ? 'https://musedam-service.test.tezign.com'
    : 'https://musedam-service.tezign.com'
export const MUSE_GLOBAL_AUTH_URL = 'https://musedam.ai/auth'
export const MUSE_MAINLAND_AUTH_URL =
  process.env.NODE_ENV === 'development'
    ? 'https://muse-web.test.tezign.com/auth'
    : 'https://musedam.cc/auth'
