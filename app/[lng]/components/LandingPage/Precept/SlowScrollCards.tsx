...
import { PreceptData } from '@/[lng]/components/LandingPage/Precept/index'
...
const Card = ({ name, role, description, avatar }: PreceptData) => {
  return (
    <div className="flex h-fit w-[360px] flex-col gap-6 rounded-[8px] bg-white p-[30px] shadow-[0_4px_30px_4px_rgba(0,0,0,0.08)]">
