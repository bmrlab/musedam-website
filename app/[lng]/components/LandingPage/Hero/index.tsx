  ...
  return (
    <div className="flex w-full flex-col items-center justify-center px-[80px]">
      ...
      <div className="mt-[80px] flex w-full items-center justify-between">
        <h1 className="font-baskervville text-[68px] font-normal leading-[77.79px] text-[#141414]">
          AI-Powered Asset Management
        </h1>
        <div className="flex max-w-[680px] flex-col items-start gap-10">
          <p className="font-mono text-[16px] font-light leading-6 text-[#141414]">
          ...
          <button className="rounded-[8px] bg-black px-[42.5px] py-[14px] font-mono text-[16px] leading-5 text-white">
            Start for free
          </button>
        </div>
      </div>
      <div className="relative mt-[80px] h-[692px] w-full px-10">
        <video
          width={1200}
          height={692}
          muted
          autoPlay
          loop
          className="absolute inset-0 size-full h-full object-cover"
        >
