...
import { useAnimationControl } from '@/[lng]/components/LandingPage/Highlights/useAnimationControl'
...
export const OrganizeImageGroup = ({ className, isBuildFinished: _isBuildFinished }: ImageGroupProps) => {
  const isMobile = useIsMobile()
  const { ref, isBuildFinished } = useAnimationControl(_isBuildFinished)
