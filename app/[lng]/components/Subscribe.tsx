...
export default function SubscribeBlock({ className }: { className?: string }) {
  return (
    ...
    >
      <h2 className="font-baskervville text-[48px] font-normal leading-[54.91px] text-white">
      ...
      <div className="flex gap-2.5">
        ...
        />
        <button className="h-[50px] rounded-[6px] bg-[#043FFB] px-[56.5px] font-mono text-[16px] leading-[20.8px] text-white">
          Subscribe
        </button>
      </div>
      <p className="font-mono text-[14px] leading-[28px]">
